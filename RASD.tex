...
\begin{document}
    ...
    \section{Overall description}
        ...
        % TODO: here the system is represented as an actor, however it shouldn't
        \begin{comment}
        ...
        % new version
        User "Zoe" has just downloaded the BPP app.
        She cretaes an account by entering the information and accepting the privacy policy.
        Once her information were verified she receives a confirmation message, becoming a "Registred user".

        \vspace{0.5cm}

        \textbf{Activity monitoring and data enrichment (automatic entry)}    
        \begin{comment}
        ...
        % maybe we could be more specific on which data the user send, since it's something that he should be aware of (if he reads the privacy agreement...)
        Registered user "Alessandro" is preparing for his weekly training session. He wants to track his performance, including correlation with the weather.
        He launches the BBP app, logs in, and starts recording his trip allowing the collection of data about GPS position and biometric data, and to record the weather condition.
        Once he finished his trip, he stops the recording and after little bit he watches ovwe the app his trip summary: the path map, the total distance rided, the average speed and weather conditions.
        \vspace{0.5cm}
        ...
        Registered user "Bianca" is riding a popular bike path when she notices that a stretch, previously marked as "Optimal", is now blocked by unreported construction. 
        She decides to alert the community, so she stop and reports the problem on the BBP app: she specifies the type of problem and adds a text note, then submits.
        
        \vspace{0.5cm}
        
        % maybe shorten it? It may be the case to ask to professor how much of system mechanism shou,d be considered or not
        ...
        "Diana", a tourist, wants to explore the city by bike but is worried about traffic and poor roads.
        She accesses the BBP website without logging in and enters "Hotel Plaza" as the origin and "Museo della Scienza" as the destination, receving three possible paths as response.
        Diana notices that the shortest route (3 km) has a low "Path Score" and is colored orange on the map, with several
        "Pothole" icons along the way. An alternative, slightly longer route (3.5 km) has an excellent "Path Score" and is highlighted in green, indicating a bike path 
        in excellent condition.
        Diana chooses the green route.
        ...
        % I think we could pospone the decision on how to implement the input reliability to a later moment.
        ...
        Registered user "Edoardo" is driving along a road where a large pothole had been reported the previous week (which he also confirmed). He is pleased to note that 
        the municipality has resurfaced the section and the pothole is no longer there.
        To keep the inventory updated, Edoardo selects the pothole marker on the map and switches it to resolved.
        After a few hours, he looks at the path to see if the changes have been applied, and finds out that the pothole marker disapeared.
        ...
        Registered User "Alessandra", after months of using BBP, wants to analyze his progress. 
        She opens the relative app section and looks at the list of all his saved trips.
        She filters the list by "Last month" and watches at the aggregated graph showing an increase in her average speed and total kilometers traveled.
        Then she selects a specific trip from two months ago to compare her average speed from that trip with her recent score.
