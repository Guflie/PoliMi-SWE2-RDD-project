...
\begin{document}
    ...
    \section{Specific requirements}
        ...
        % -------------------------------------------------------
        % Leonardo's proposals
        % -----
        % General note: these requirements need an improvement on grammar, structure ecc ecc, they're sole purpouse is to sketch the meaning
        % -------------------------------------------------------
        \paragraph{Sign up \& Login}
        \begin{itemize}
            \item \textbf{R1}: The system shall allow the user to create a new account
            \item \textbf{R2}: If the user has already an account, the system should allow the user to log into It
        \end{itemize}

        \paragraph{Profile management}
        \begin{itemize}
            \item \textbf{R3}: The system shall allow the user to add personal information to its account
            \item \textbf{R4}: The sstem shall allow the user to modidy its personal informations
            \item \textbf{R5}: The system shall allow the user to remove its personal informations
            \item \textbf{R6}: The system shall allow the user to delete its account
        \end{itemize}

        \paragraph{Path planning}
        \begin{itemize}
            \item \textbf{R7}: The system shall allow to user to search a cycling path given starting point and destination
            \item \textbf{R8}: The system shall allow the user to filter the search on variuos matrics, as trip difficulty, shortest path ...
            \item \textbf{R9}: The system shall allow the user to browse throught a set of paths during after a search
            \item \textbf{R10}: The system shall show to the user the path's properties within search output
        \end{itemize}

        \paragraph{Trip recording}
        \begin{itemize}
            % add more specificity on this one
            \item \textbf{R11}: The system shall allow registred user to measure automatically its performances during its trip
            \item \textbf{R12}: The system shall allow registred users to interrupt and resume the recording activity
            \item \textbf{R13}: If weather info are available, the system should allow registred users to enrich their activities with those infos

        \end{itemize}

        \paragraph{Trip feedback}
        \begin{itemize}
            \item \textbf{R14}: If the registred user give the permission, the system shall automatically record possible path's problems during the trip
            \item \textbf{R15}: Once the registred user trip is concluded and the trip was recorded, the system shall ask confirmation to the user about the problem it has detected
            \item \textbf{R16}: The system shall allow registred users to update the state of a path manually
            \item \textbf{R17}: The system shall allow the registred users to rate paths
        \end{itemize}

        \paragraph{Trip history management}
        \begin{itemize}
            \item \textbf{R18}: The system shall allow registred users to look @ their trip history
            \item \textbf{R19}: The system shall allow registred users to delete one trip from their history
            \item \textbf{R20}: The system shall allow registred users to search for trips among their trip history
            \item \textbf{R21}: The system shall alloe registred users to apply filters during the search within their trip history
        \end{itemize}
