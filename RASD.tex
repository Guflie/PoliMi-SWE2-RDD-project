...
\begin{document}
    ...
    \section{Introduction}
        ...
        If a route is present in the inventory, it is displayed with its quality score; otherwise, it is shown as an unverified path. 
        If multiple routes exist, BBP will present them based on a score, calculated based on the route status derived from the 
