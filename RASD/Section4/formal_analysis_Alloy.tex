...
The model leverages Alloy 6's temporal logic capabilities to verify the dynamic behavior of the system over time.
    ...
    \begin{lstlisting}[language=alloy, caption={Predicate: Data Lifecycle Reachability}]
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{alloy_user_distinction.png}}
    ...
    The second run verifies the temporal evolution of a Report. 
    The following figures illustrate the transition satisfying the Data Governance requirements defined in Section 3:
    \begin{itemize}
        \item Figure \ref{fig:lifecycle_t0} shows the initial creation state where the data is \texttt{Pending}.
        \item Figure \ref{fig:lifecycle_t1} shows the subsequent validation state where the status becomes \texttt{Confirmed}.
    \end{itemize}

    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{alloy_lifecycle_T0.png}}
        ...
        \label{fig:lifecycle_t0}
    \end{figure}

    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{alloy_lifecycle_T1.png}}
