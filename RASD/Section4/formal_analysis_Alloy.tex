...
The model leverages Alloy 6's temporal logic capabilities to verify the dynamic behavior of the system over time.
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{../img/RASD/alloy/alloy_user_distinction.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/alloy_activity_lifecycle_t0.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/alloy_activity_lifecycle_t1.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/alloy_activity_lifecycle_t2.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/activity_paused_t0.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/activity_paused_t1.png}}
    ...
    \end{figure}
        ...
        \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/activity_weather_t0.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/activity_weather_t1.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/alloy/alloy_data_lifecycle.pdf}}
