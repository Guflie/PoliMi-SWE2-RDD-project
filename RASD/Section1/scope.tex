...
\begin{itemize}
    ...
    \item \textbf{User}
    % What about just user? Any user sounds a little bit cumbersome to me
    %\item \textbf{Any User} 
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{WP7:} The registered user forgots the password.
    ...
    \item \textbf{WP11:} The user stops to cycling.
...
\begin{itemize}
    ...
    \item \textbf{SP\_WC9:} The user starts an activity.
    \item \textbf{SP\_WC10:} The external mapping service sends to the system a list of paths
    \item \textbf{SP\_WC11:} The user stops the ongoing activity.
    \item \textbf{SP\_WC12:} The user resumes the stopped activity.
    \item \textbf{SP\_WC13:} The user terminates the activity.
    \item \textbf{SP\_WC14:} The registered user submits the path evaluation.
    \item \textbf{SP\_WC15:} The registered user enables to automatically collect data during an activity.
    \item \textbf{SP\_WC16:} The registered user's personal device sends to the system sampled data upon activity completition.
    \item \textbf{SP\_WC17:} The external weather service sends to the system weather conditions for a given path.
