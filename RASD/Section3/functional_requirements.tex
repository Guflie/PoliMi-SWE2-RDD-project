\subsection{Functional requirements}
    ...
    \begin{itemize}
        ...
        \item \textbf{[R3]} the system shall allow registred user to reset their account password
    ...
    \begin{itemize}
        \item \textbf{[R6]} The system shall allow registered user to start the recording of a new trip.
        \item \textbf{[R7]} The system shall allow registered user to pause and resume the recording of an active trip.
...
%        \item \textbf{[R7]} The system shall allow registered user to save a trip.
        ...
        if available, and associate it to the saved trip.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{[R13]} The system shall allow registered user to enable automatic detection during a trip.
