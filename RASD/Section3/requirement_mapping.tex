\subsubsection{Requirement Mapping}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|p{0.45\textwidth}|p{0.45\textwidth}|}
            ...
            \textbf{[R3]} the system shall allow registred user to reset their account password
            ...
            \textbf{[R6]} The system shall allow registered user to start the recording of a new trip. \newline
            \textbf{[R7]} The system shall allow registered user to pause and resume the recording of an active trip. \newline
