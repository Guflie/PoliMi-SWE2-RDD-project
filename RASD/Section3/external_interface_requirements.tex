\subsection{External interface requirements}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{RASD/mockups/mockup_login.jpg} 
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{RASD/mockups/mockup_search.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{RASD/mockups/mockup_confirmation.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{RASD/mockups/mockup_history.jpg}
