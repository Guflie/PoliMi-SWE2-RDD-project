...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{RASD/Use case/Use_case_diagram_v0.pdf}
...
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            ...
            \hline
            Actors & General user \\ % Is this terminology correct?
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The system asks to the user to fill out a form with the following personal information: name, surname, birth date, geneder, email, password; the systems laso asks to accept the privacy terms
        ...
        \begin{tabular}{|l|l|}
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The system receives the user's login info, checks that the information sent corresponds to an existing account
                    \item The system retrive the information to build the homepage for that account and sends it
                \end{enumerate}
                \smallskip
                \end{minipage}
            \\
            \hline
            Exit Condition & The user recevies the homepage for the account \\
            \hline
            Exception & 
            \begin{minipage}{0.7\textwidth}
            \smallskip
                ...
                \item The user sends a password that doesn't match with the one on the system for that account, therefore the system sends an errore message to the user
            \end{itemize} 
            \smallskip
            \end{minipage}
            \\
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC3] Account information update}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The user selects the attribute to modify (email address and password are excluded), types the new value and sends it
                    % review this step
                    \item The system modifies the attributes and sends an acknowledgment
                \end{enumerate}
                \smallskip
                \end{minipage}
            \\
            \hline
            Exit Condition & The account profile is updated \\
            \hline
            Exception & \\
            \hline       
        \end{tabular}
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC4] Password account reset}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The system receives the account email, checks whether an account with that email exists or not, 
                    and if it finds it sends an email to that address with a link to reset the password that expires in 1 hour
            ...
            \\
            \hline
            Exit Condition & The user can log-in with the new password \\
            \hline
            Exception &
                \begin{minipage}{0.7\textwidth}
                \smallskip
                \begin{itemize}
                    \item The user doesn't open the link within one hour, therefore the password wouldn't be changed 
                    \item The user doesn't submits the new password after opening the link within one hour, therefore the password wouldn't be changed
                \end{itemize}
                \end{minipage}
            \\
            \hline       
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC5] Account deletion}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            \smallskip
                \begin{itemize}
                \item The user didn't open the link after one hour, therefore the link expries
                \item The user didn't confirm the second time, therefore after one hour the request expires
            \end{itemize} 
            \smallskip
            \end{minipage}
            \\
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC6] Route planning with route match}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    % TODO: we allow the same path to be traveld partially? Is this reasonable since we don't have to bother about how much would the score be adjusted in this case?
            ...
            \smallskip
                \begin{itemize}
                \item No path between starting point and destination is found, see \ref{UC:UC7}
            \end{itemize} 
            \smallskip
            \end{minipage}
            \\
...
% --------------------------------------------------------------------------------------------------.
% TODO: finish this
\paragraph{[UC7] Route planning without route match}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    % TODO: give a second look to these last two points (external mapping service seems to be an user?)
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC8] Trip activity for unregistered user}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            Name & \textbf{Trip activity} \\
            \hline
            Actors & Not registered user \\
            \hline
            Entry Condition & \\
            \hline
            Event Flow & 
                ...
                \smallskip
                \begin{enumerate}
                    \item The user selects the path and starts the trip, sending an information retrieval request to the system
                    \item The system receives the request, retrieves the path map and sends it to the user
                    \item The user receives the path map
                        \subitem The user might stop and resume the trip whenever he likes
                    \item The user completes the trip, and sends an "Trip Completion message" to the system
                    \item The system receives the message and sends an acknowledgement
                \end{enumerate}
                \smallskip
                \end{minipage}
            \\
            \hline
            Exit Condition & The user did its trip \\
            \hline
            Exception & \\
            \hline       
        \end{tabular}
...
\paragraph{[UC9] Trip activity for registered user}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The system receives the rating form and sends an acknowledgement 
                \end{enumerate}
                \smallskip
                \end{minipage}
            \\
            \hline
            Exit Condition & The user did its trip activity and gave a score to the path\\
            \hline
            Exception & \\
            \hline       
        \end{tabular}
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC10] Automatic trip monitoring}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The system retrives the weather conditions during the activty from a third-part weather service
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC11] Manual route problem report}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC12] Route problem fixup report}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC13] Automatic route problem detection and report}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Event Flow & 
                ...
                \begin{enumerate}
                    ...
                    \item The user confirmes whether the problems detected are real issues or false positives
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC14] User's activity history consultation}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
...
% --------------------------------------------------------------------------------------------------
\paragraph{[UC15] User activity deletion}
\begin{center}
    \begin{table}[h!]
        \begin{tabular}{|l|l|}
            \hline
            ...
            Actors & Registered user \\
            \hline
            Entry Condition & Registered user has at least one trip recorded \\
            \hline
            Event Flow & 
                \begin{minipage}{0.7\textwidth}
                \smallskip
                \begin{enumerate}
                    \item The user opens the Acivity History and searches for the trip to delete
                    \item The user selects the trip, selects the option to delete it and confirms the deletion.
                    \item The system recevies the deletion request, deletes the activity and sends an acknowledgement to the user.
                \end{enumerate}
                \smallskip
                \end{minipage}
            \\
            \hline
            Exit Condition & The user no longer have the trip in its history \\
            \hline
            Exception & \\
            \hline       
        \end{tabular}
