...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{../img/RASD/Use case/use_case_diagram_v2.pdf}}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{|l|l|}
        ...
        Exception & 
            ...
            \smallskip
            \begin{itemize}
            \item Weather conditions can't be retrived from the third party 
