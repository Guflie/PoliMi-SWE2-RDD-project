...
\begin{table}[ht!]
    ...
    \begin{tabular}{|l|l|}
        ...
        Exit Condition & 
            \begin{minipage}{0.7\textwidth}
            \smallskip
            The account profile is updated. If not, an error meassge is diplayed and the account isn't updated. 
            \smallskip
            \end{minipage}
        \\
        \hline
...
\begin{table}[ht!]
    ...
    \begin{tabular}{|l|l|}
        ...
        Exit Condition &
            ...
            and are sent within expiration time. If the informations are not correct, the systems send an error 
            messagge and the password isn't updated.    
            \smallskip           
            \end{minipage}
        \\
        \hline
