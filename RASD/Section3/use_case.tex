...
\begin{table}[ht!]
    ...
    \begin{tabular}{|l|l|}
        ...
        \smallskip
            ...
            \item The user doesn't open the confirmation link within an hour, therefore the account creation procedure is aborted and the submited data cancelled. If the confirmation link is
