...
\begin{table}[ht!]
    \begin{tabular}{|l|l|}
        ...
        \\
        \hline
        Exit Condition & The account profile is updated. If not, an error meassge is diplayed and the account isn't updated. \\
        \hline
        Exception &
        \begin{minipage}{0.7\textwidth}
        \smallskip
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|}
        ...
        \\
        \hline
        Exit Condition & The user can log-in with the new password if the information submitted are truthfull and are sent within expiration time. 
        If the informations are not correct, the systems send an error messagge and the password isn't updated.\\
        \hline
        Exception &
            \begin{minipage}{0.7\textwidth}
            \smallskip
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The system sends to the user the activity summary, waether conditions plus the map showing the path traveled
            \end{enumerate}
            \smallskip
            \end{minipage}
        \\
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The system recevies the deletion request and sends an acknowledgement to the user.
            \end{enumerate}
            \smallskip
            \end{minipage}
        \\
