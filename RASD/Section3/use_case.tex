    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The system asks to the user to fill out a form with the following personal information: name, surname, birth date, geneder, email, password; the systems also asks to accept the privacy terms
                \item The person fills out the questionare and submits it
                \item The system verifies that the email address is valid and that it's not already been used, then it sends a verification email containing a link to verify the email address, which expires in 1 hour
        ...
        \smallskip
            ...
            \item The user doesn't open the confirmation link within an hour, therefore the account creation procedure is aborted and the submited data cancelled.
        \end{itemize} 
        \smallskip
        \end{minipage}
        \\
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|}
        ...
        \\
        \hline
        Exit Condition & The user logs into its account \\
        \hline
        Exception & 
        \begin{minipage}{0.7\textwidth}
        \smallskip
...
% --------------------------------------------------------------------------------------------------
% review how to handle the case in which the user tries to modify email address or password
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The user selects the attribute to modify, types the new value and sends it
        ...
        \smallskip
        \begin{enumerate}
            \item The user tries to modify email address and password, therefore it's immediately blocked
        \end{enumerate}
        \smallskip
        \end{minipage}
         \\
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The user starts the trip activity for the selected path, see UC\ref{UC:UC8}, UC:\ref{UC:UC9}.
            \end{enumerate}
            \smallskip
            \end{minipage}
        \\
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The user completes the trip and closes it
            \end{enumerate}
            \smallskip
            \end{minipage}
        \\
    ...
    \begin{tabular}{|l|l|}
        ...
        Event Flow & 
            ...
            \begin{enumerate}
                ...
                \item The system sends a request to retirve weather conditions during the activty to a third-part Weather Service
        ...
        \\
        \hline
        Exit Condition & The user completed the activity with related metrics \\
        \hline
        Exception & 
        \begin{minipage}{0.7\textwidth}
        \smallskip
