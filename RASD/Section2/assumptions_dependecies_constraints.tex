\subsection{Assumptions, dependencies and constraints}
    ...
    \begin{itemize} %ci vengono in mente altri domain assumptions??? sei d'accordo con quelli che ho appena elencato?            
        ...
        reality, that is if a road exists on the map then it's assumed that physically exists and that it is drivable safely by bicycles (unless otherwise reported on BBP).
