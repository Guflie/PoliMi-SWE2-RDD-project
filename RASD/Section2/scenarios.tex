...
\paragraph{[SC1] Registering a new user} \phantomsection\label{sc:SC1}
\begin{flushleft}
...
\paragraph{[SC2] Intelligent route planning (General user) } \phantomsection\label{sc:SC2}
\begin{flushleft}
...
\paragraph{[SC3] Intelligent route planning (Registred user) } \phantomsection\label{sc:SC3}
\begin{flushleft}
...
\paragraph{[SC4] Automatic activity monitoring and trip data enrichment } \phantomsection\label{sc:SC4}
\begin{flushleft}    
...
\paragraph{[SC5] Manual path information update 1 } \phantomsection\label{sc:SC5}
\begin{flushleft}
...
\paragraph{[SC6] Manual path information update 2 } \phantomsection\label{sc:SC6}
\begin{flushleft}
...
\paragraph{[SC7] Automatic path information update } \phantomsection\label{sc:SC7}
\begin{flushleft}
...
\paragraph{[SC8] Historical performance analysis } \phantomsection\label{sc:SC8}
\begin{flushleft}
...
\paragraph{[SC9] Trip deletion} \phantomsection\label{sc:SC9}
\begin{flushleft}
...
\paragraph{[SC10] Account information update} \phantomsection\label{sc:SC10}
\begin{flushleft}
...
\paragraph{[SC11] Account deletion} \phantomsection\label{sc:SC11}
\begin{flushleft}
...
\paragraph{[SC12] Account password reset} \phantomsection\label{sc:SC12}
\begin{comment}
\paragraph{[SC9] Password Recovery}
Registered user "Marco" hasn't used the BBP app during the winter season. With spring arriving, he wants to log in to check his past stats, but he 
realizes he has forgotten his password. On the login screen, he selects the "Forgot your password?" link. He enters the email address associated with 
his account and submits the request. The system sends him an email containing a secure reset link. Marco clicks the link, gets redirected to a secure 
page where he sets a new password, and confirms it. Finally, he is able to log in successfully using the new credentials.
\end{comment}
\begin{flushleft}
...
\end{flushleft}
%Il tuo scenario è descritto meglio rispetto al mio, vada per il tuo!
