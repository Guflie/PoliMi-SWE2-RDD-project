...
\paragraph{[SC6] Intelligent route planning with successful match (Causal user) } \phantomsection\label{sc:SC6}
\begin{flushleft}
...
He selects the option to create a new path, select one of the proposed alternatives and starts the trip.  
\end{flushleft}
...
She then selects the option to create a new path, and starts the activity following one of the suggested path.
\end{flushleft}

% TODO: discuss this with Francesco if this might be relevant to extends the mockup
% TODO: review this
...
\begin{flushleft}
User "Tony" started an activity, but in the middle of it, he encounters his old friend "Side" and stops for a chat.
...
Upon completion, she receives from the app the summary of the activity and a small form to sore the route.
...
He notices that there two potholes were detected: one approximately in the middle of the path, and another one near his work building.
Since he didn't encountered a pothole in the middle of the path, he selects it and discards it.
He then selects the pothole near his work building, confirms it and adds an optional note to be more detailed.
\end{flushleft}
...
She also adds an optional textual note for more detailed, then submits the report, receiving an acknowledgement
\end{flushleft}
