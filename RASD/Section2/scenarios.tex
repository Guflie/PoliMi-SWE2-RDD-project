...
\begin{flushleft}
Registred user "Giulio" noticed that during the creation of his account selected the wrong birth date.
...
\begin{flushleft}
After months of stops, "Mirko" doesn't want to cycle anymore and decides to delete his BBP account.
...
\begin{flushleft}
Registred user "Vittorio" changed mobile device, installed the BBP app but when he tries to log in, he realize that he forgot the password.
