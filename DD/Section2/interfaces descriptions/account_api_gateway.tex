...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        ...
        \hline
        Signature & send\_create\_conf(regToken): void \\
        \hline
        Description & Forards to the system the confirmation token after the user clicks the email link. \\
        \hline
        Parameters &
            \begin{minipage}{0.8\textwidth}
            \smallskip
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        \hline
        Name & \multicolumn{1}{c|}{\textbf{Forward Modify Attribute Request}} \\ 
        \hline
        Signature & frw\_modify\_attr(userId, attrId, newVal): void \\
        \hline
        Description & Forward the modification of an account ttribute modification to the system. \\
        \hline
        Parameters &
            \begin{minipage}{0.8\textwidth}
            \smallskip
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        ...
        \hline
        Signature & frw\_new\_psw(newPsw, resetToken): void \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        ...
        \hline
        Signature & frw\_acc\_del\_conf(delToken): void \\
        \hline
