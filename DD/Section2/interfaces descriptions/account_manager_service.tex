...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        ...
        \hline
        Signature & create\_acc\_info(newUserId, name, surname, gender, birthdate): status \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        ...
        \hline
        Signature & modify\_attr(userId, attrId, newVal): status \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.8\textwidth}|}
        \hline
        Name & \multicolumn{1}{c|}{\textbf{Delete Account}} \\ 
        \hline
        Signature & delete\_acc(userId): status \\
        \hline
