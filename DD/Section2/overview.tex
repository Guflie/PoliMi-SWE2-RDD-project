...
For the BBP system we opted to base the architecture on a \textbf{4-Layer Architecture}. This structural design was chosen to ensure 
a strict separation of concerns, thereby maximizing both maintainability and operational efficiency. The architecture is 
composed of the following distinct layers:
\begin{enumerate}
    \item \textit{Presentation Layer}, which serves as the pooint of contact for the user. It is strictly responsible for 
    ...
    system funcitonalities, implementing complex functionalities such as trip planning algorithms and comprehensive account management.
