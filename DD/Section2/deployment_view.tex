...
Responsible for traffic distribution, these components serve as the entry point for requests intended for the API gateway layer. 
In order to facilitating the granular management of traffic on the specific requirements of each service macro-category, a dedicated 
load balancing instance is utilized for each gateway type.
