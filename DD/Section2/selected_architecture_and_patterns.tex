...
\begin{itemize} 
    ...
    interaction, allowing the user to interact easily with the system.
    ...
    real-time data sampling and on-device pattern recognition for identifying issues during recorded trips. To handle the issue-recognition task, we've chose to use pre-trained lightweight machine learning models.
    ...
    \item \textbf{Data Layer}: Dedicated to the persistence and orchestration of system information, this layer consists of a distributed database cluster. It manages data integrity and retrieval across all
    nodes, implementing different storage strategies based on the specific type of data is handling.
\end{itemize}
