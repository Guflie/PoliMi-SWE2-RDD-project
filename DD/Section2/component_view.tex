...
In this section and the following ones we focus on describing the \textit{Back-end Application Layer} internal strcuture and its interaction with the \textit{Data layer}.
...
This service is responsible for retriving and merging all the information necessary to the user during trip planning. To 
