...
In this section we focus on describing the \textit{Back-end Application Layer} internal strcuture and it's interaction with the \textit{Data layer}.
...
% after identifing the responsibilities of the front-end layer expand this.
...
Manages user account information and profile updates. It hanlde the access to the data stored in the \textit{Account DBMS}, 
...
In order to avoid ripple effect slowing down the entire system, \textit{Circuit Breakers} are positioned one those components which should have high responsivness
