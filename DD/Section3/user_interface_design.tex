...
\section{User Interface Design}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{Login_mockup.pdf} 
    ...
    \begin{itemize}
        ...
        \textit{Map View} (Fig. \ref{fig:ui_map}) with limited functionality.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{mockup_search.pdf}
    ...
    \textbf{Transitions and Logic:}
    \begin{itemize}
        \item \textbf{Route Selection:} Interacting with search results or tracks on the map updates the \textit{Bottom Sheet} shown in the figure.
        
        \item \textbf{Start Navigation:} The \uiElement{Start} button initializes the \texttt{Tracking} state, placing the interface in "Driving Mode".
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{mockup_confirmation.pdf}
    ...
    \begin{itemize}
        ...
        database, and redirects the user to the \textit{History/Profile} view.
    \end{itemize}
    \pagebreak
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{Mockup_history.pdf}
