...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textit{Requirement Analysis and Specification Document (RASD)} - Version 1.0, Best Bike Paths.
            \item \textit{Assignment RDD} - Software Engineering II, Politecnico di Milano, A.Y. 2025-2026.
        \end{itemize}
        ...
        \begin{itemize}
            \item \textit{PlantUML} - Open-source tool used to generate Dependency diagram via code.
