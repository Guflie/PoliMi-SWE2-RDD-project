...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{4.5cm}|c|c|}
        ...
        Responsible to create new account. Important for overall experience, but Guest Mode mitigates the inconvenience.&
        \cellcolor{medium}\textbf{2} \\
        \hline
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.7\textwidth]{DD/dependency_diagram.pdf}}
    \label{fig:dep_graph}
...
\begin{itemize}
    \item \textbf{Action:} Develop simultaneously the \textit{Credential Subsystem} and \textit{Account Subsystem}. After this, develop the secondary modules 
    \textit{Account Creation} and \textit{Email Proxy}.
