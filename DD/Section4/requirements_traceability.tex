...
\begin{longtable}{|c|p{3.0cm}|c|c|c|c|c|c|c|c|c|c|c|c|c|c|} 
    ...
    % --- TRIP RECORDING ---
    \textbf{R6} & Start recording & X & & & & & & & & & & & & & \\ \hline
    \textbf{R7} & Pause/Resume & X & & & & & & & & & & & & &  \\ \hline
    \textbf{R8} & Save activity & X & & X & & & & & X & X & & & & &  \\ \hline
    \textbf{R9} & Track pos. \& stats & X & & & & & & & & & & & & & \\ \hline
    \textbf{R10} & Retrieve weather & & & & & & & & X & & & X & & X & \\ \hline

    % --- DATA CONTRIBUTION ---
    \textbf{R11} & Report path status & X & & X & & & & & & & & & X & & \\ \hline
    \textbf{R12} & Submit feedback & X & & X & & & & & & & & & X & & \\ \hline
    \textbf{R13} & Report problems & X & & X & & & & & & & & & X & & \\ \hline
    \textbf{R14} & Enable auto-detect & X & & & & & & & & & & & & & \\ \hline
    \textbf{R15} & Analyze anomalies & X & & & & & & & & & & & & & \\ \hline
    \textbf{R16} & Review anomalies & X & & & & & & & & & & & & & \\ \hline
    \textbf{R17} & Confirm anomaly & X & & X & & & & & & & & & X & & \\ \hline

    % --- PATH PLANNING ---
    \textbf{R18} & Compute routes & X & & X & & & & & & & X & X & X & & \\ \hline
    \textbf{R19} & Visualize routes & X & & X & & & & & & & X & X & & & \\ \hline
    \textbf{R20} & Path Score & & & & & & & & & & & & X & & \\ \hline
    \textbf{R21} & Display obstacles & X & & X & & & & & & & & & X & & \\ \hline
    \textbf{R22} & Filter search & X & & X & & & & & & & X & X & & & \\ \hline

    % --- TRIP HISTORY ---
    \textbf{R23} & View list & X & & X & & & & & & X & & & & & \\ \hline
    \textbf{R24} & View trip details & X & & X & & & & & & X & & X & & & \\ \hline
    \textbf{R25} & Delete activity & X & & X & & & & & & X & & & & & \\ \hline
    \textbf{R26} & Search activity & X & & X & & & & & & X & & & & & \\ \hline
    \textbf{R27} & Filter history & X & & X & & & & & & X & & & & & \\ \hline
